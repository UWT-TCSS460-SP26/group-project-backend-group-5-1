...
function so(e, t) {
  ...
  for (t == null ? ((Q = !1), (a = S)) : (a = t), s = new T(0.03125); e.abs().gte(0.1); )
    ((e = e.times(s)), (f += 5));
  for (
...
function Mt(e, t) {
  ...
  if (
    ((f += v), (R.precision = f), (r = Ee(N)), (n = r.charAt(0)), (o = z(A)), Math.abs(o) < 15e14)
  ) {
  ...
  co = xe(() => {
    ...
    C.toDecimalPlaces = C.todp = function (e, t) {
      ...
      return (
        ...
        e === void 0
          ? r
          : (Te(e, 0, at), t === void 0 ? (t = n.rounding) : Te(t, 0, 8), _(r, e + z(r) + 1, t))
      );
    };
    ...
    Oe = (function () {
      ...
      return function (n, i, o, s) {
        ...
        for (
          m = n.e - i.e, ge = H.length, Qe = be.length, A = new yr($l), N = A.d = [], f = 0;
          H[f] == (be[f] || 0);
        )
          ++f;
        if (
...
function ic(e) {
  let t = {
    ...
    r = (...n) => {
      ...
      if (
        (n.length !== 0 && _t.push([o, ...n]), _t.length > rc && _t.shift(), Ft.enabled(o) || i)
      ) {
...
function bc(e) {
  ...
  for (let n of e) {
    ...
    o
      ? t.set(i, {
          ...n,
          argument: { ...n.argument, typeNames: xc(o.argument.typeNames, n.argument.typeNames) },
        })
      : t.set(i, n);
  }
    ...
    case 'templateSql':
      return (e.chunkable ? Wd(e.fragments, i, n) : [i]).map((s) => {
        ...
        if (n !== void 0 && a.args.length > n)
          throw new X('The query parameter limit supported by your database is exceeded.', 'P2029');
        return a;
      });
    default:
      ...
      case 'execute': {
        ...
        for (let o of n) {
          ...
          i += await this.#l(s, r.queryable, () =>
            r.queryable.executeRaw(Li(s)).catch((a) => (t.args.type === 'rawSql' ? ii(a) : vt(a)))
          );
        }
        return { value: i };
      }
        ...
        for (let o of n) {
          let s = yu(o, r.sqlCommenter),
            a = await this.#l(s, r.queryable, () =>
              r.queryable.queryRaw(Li(s)).catch((m) => (t.args.type === 'rawSql' ? ii(m) : vt(m)))
            );
    ...
    async #r(t) {
      ...
      switch (
        ...
        case 'waiting':
          if (n.signal.aborted)
            throw (
              o.then((s) => s.rollback()).catch((s) => Ot('error in discarded transaction:', s)),
  ...
  async request(t, { interactiveTransaction: r, customDataProxyFetch: n }) {
    ...
    if (Ku(t)) s = Zu(t);
      ...
      v
        ...
        : (Le('query plan cache miss'), (s = this.#f(m, T, o)), S && this.#i?.setSingle(T, s));
    }
    try {
